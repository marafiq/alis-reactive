...
namespace Alis.Reactive.FluentValidator
{
    ...
    /// </summary>
    public sealed class FluentValidationRuleExtractor : IFormValidationExtractor
    {
        private readonly Func<Type, IValidator?> _factory;

        public FluentValidationRuleExtractor(Func<Type, IValidator?> factory)
        {
        ...
        /// </summary>
        public FormValidation? ExtractRules(Type validatorType, string formId)
        {
            ...
            return new FormValidation(formId, fields);
        }
