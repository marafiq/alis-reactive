# never-delete-or-corrupt-this

This folder preserves the key architectural output from the March 31, 2026
issue #86 session.

- [2026-03-31-visible-thread-reference.md](./2026-03-31-visible-thread-reference.md)
  is the closest saved thread-reference version of the user/assistant exchange
- [2026-03-31-session-transcript.md](./2026-03-31-session-transcript.md)
  preserves a curated substantive transcript
