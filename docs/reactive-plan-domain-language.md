...
| FluentValidation Projection Draft | Source-specific accumulator used while walking a FluentValidation validator. It owns fields, projected rule intents, peer-field discovery, and shape evidence before client validation fields are returned. |
...
| Comparison Rule Operands | Projection object for FluentValidation comparison rules. It classifies fixed literals, same-object peer fields, unsupported peer shapes, and cross-object peer comparisons before emitting the browser rule intent. |
