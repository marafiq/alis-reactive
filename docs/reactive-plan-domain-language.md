...
| Range Endpoint Values | Projection object for FluentValidation range endpoints. Complete endpoints produce validation range bounds with serialized date literals; missing endpoints produce a skipped client projection rather than an invented browser rule. |
