...
namespace Alis.Reactive
{
    ...
    public sealed class ComponentRegistration
    {
        ...
        /// <summary>Component vendor, such as <c>native</c> or <c>fusion</c>, used by runtime resolution.</summary>
        public string Vendor => _identity.Vendor.Value;

        /// <summary>Model property path used to join input registration with gather and validation metadata.</summary>
        public string BindingPath => _binding.BindingPath.Value;

        /// <summary>Dot-path from the component root to the readable value, such as <c>value</c> or <c>checked</c>.</summary>
        public string ValueMember => _binding.ValueMember.Value;

        /// <summary>Semantic component kind, such as <c>datepicker</c> or <c>numerictextbox</c>.</summary>
