...
namespace Alis.Reactive
{
    ...
    public static class ExpressionPathHelper
    {
        ...
        /// <summary>
        /// Builds a scoped camelCase runtime path from a typed property-access expression.
        /// </summary>
        /// <typeparam name="TSource">The source type containing the property chain.</typeparam>
        /// <typeparam name="TProp">The value type at the end of the runtime path.</typeparam>
        ...
        /// <summary>
        /// Builds a typed camelCase path relative to the current event payload scope.
        /// </summary>
        /// <typeparam name="TSource">The event payload type.</typeparam>
        /// <typeparam name="TProp">The event value type at the selected payload path.</typeparam>
        /// <param name="expression">The property-access expression to convert.</param>
        ...
        /// <summary>
        /// Builds a typed camelCase path relative to the current HTTP response body scope.
        /// </summary>
        /// <typeparam name="TSource">The response body type.</typeparam>
        /// <typeparam name="TProp">The response value type at the selected body path.</typeparam>
        /// <param name="expression">The property-access expression to convert.</param>
        /// <returns>A dot-path like <c>data.name</c>.</returns>
        ...
        /// <summary>
        /// Extracts the MVC model-binding path from a typed model expression.
        /// </summary>
        /// <typeparam name="TModel">The view model that owns the property path.</typeparam>
        /// <typeparam name="TProp">The model value type at the selected binding path.</typeparam>
        /// <param name="expression">The model property expression.</param>
        /// <returns>A dot-separated binding path like <c>"Address.City"</c>.</returns>
        ...
        /// <summary>
        /// Converts a typed model expression to the MVC DOM element ID generated by <c>Html.IdFor()</c>.
        /// </summary>
        /// <typeparam name="TModel">The view model that owns the property path.</typeparam>
        /// <typeparam name="TProp">The model value type represented by the generated element ID.</typeparam>
        /// <param name="expression">The model property expression.</param>
        /// <returns>An underscore-separated element ID like <c>"Address_City"</c>.</returns>
