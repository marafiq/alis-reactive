...
{
    internal sealed class AuthoredPlan
    {
    ...
    internal sealed class FieldBinding
    {
        ...
        internal FieldBinding(string @object, string readMember, ValueShape shape)
        {
            Object = @object;
            ValueMember = readMember;
            Shape = shape;
        }
    }
    ...
    internal sealed class AccessValueExpr : ValueExpr
    {
        [JsonPropertyOrder(-1)]
        ...
        internal AccessValueExpr(ValueExpr value, List<PathSegment> path)
        {
            Value = value;
            Path = path;
        }
    ...
    internal sealed class BindingMapValueExpr : ValueExpr
    {
        [JsonPropertyOrder(-1)]
    ...
    internal sealed class RequestInput
    {
        ...
        internal RequestInput(string transport, ValueExpr value)
        {
            Transport = transport;
            Value = value;
        }
