# FusionAiAssistView Master Use Cases
...
`FusionAiAssistView`. Existing C#, sandbox, tests, docs, and memory are evidence
only after raw EJ2 discovery and primitive mapping prove them.

Syncfusion target: `ej.interactivechat.AIAssistView`
...
| Item | Count |
|---|---:|
| Static JS members | 36 |
| Static event members | 7 |
| Event payload entries | 7 |
