# FusionInPlaceEditor Master Use Cases
...
`FusionInPlaceEditor`. Existing C#, sandbox, tests, docs, and memory are evidence
only after raw EJ2 discovery and primitive mapping prove them.

Syncfusion target: `ej.inplaceeditor.InPlaceEditor`
...
| Item | Count |
|---|---:|
| Static JS members | 53 |
| Static event members | 12 |
| Event payload entries | 12 |
