...
`FusionDialog`. Existing C#, sandbox, tests, docs, and memory are evidence
only after raw EJ2 discovery and primitive mapping prove them.

Syncfusion target: `ej.popups.Dialog`
...
| Static event members | 14 |
| Event payload entries | 14 |
