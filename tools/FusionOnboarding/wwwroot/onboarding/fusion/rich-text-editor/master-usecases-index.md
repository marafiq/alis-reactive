# FusionRichTextEditor Master Use Cases
...
`FusionRichTextEditor`. Existing C#, sandbox, tests, docs, and memory are evidence
only after raw EJ2 discovery and primitive mapping prove them.

Syncfusion target: `ej.richtexteditor.RichTextEditor`
...
| Item | Count |
|---|---:|
| Static JS members | 211 |
| Static event members | 49 |
| Event payload entries | 49 |
