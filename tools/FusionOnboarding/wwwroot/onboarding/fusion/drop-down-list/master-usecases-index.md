# FusionDropDownList Master Use Cases
...
`FusionDropDownList`. Existing C#, sandbox, tests, docs, and memory are evidence
only after raw EJ2 discovery and primitive mapping prove them.

Syncfusion target: `ej.dropdowns.DropDownList`
...
| Item | Count |
|---|---:|
| Static JS members | 46 |
| Static event members | 10 |
| Event payload entries | 10 |
