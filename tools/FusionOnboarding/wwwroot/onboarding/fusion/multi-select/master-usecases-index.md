# FusionMultiSelect Master Use Cases
...
`FusionMultiSelect`. Existing C#, sandbox, tests, docs, and memory are evidence
only after raw EJ2 discovery and primitive mapping prove them.

Syncfusion target: `ej.dropdowns.MultiSelect`
...
| Item | Count |
|---|---:|
| Static JS members | 82 |
| Static event members | 17 |
| Event payload entries | 17 |
