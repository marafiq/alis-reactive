# FusionPivotView Master Use Cases
...
`FusionPivotView`. Existing C#, sandbox, tests, docs, and memory are evidence
only after raw EJ2 discovery and primitive mapping prove them.

Syncfusion target: `ej.pivotview.PivotView`
...
| Item | Count |
|---|---:|
| Static JS members | 246 |
| Static event members | 51 |
| Event payload entries | 51 |
