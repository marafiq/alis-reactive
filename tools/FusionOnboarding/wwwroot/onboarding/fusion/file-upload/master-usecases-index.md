# FusionFileUpload Master Use Cases
...
`FusionFileUpload`. Existing C#, sandbox, tests, docs, and memory are evidence
only after raw EJ2 discovery and primitive mapping prove them.

Syncfusion target: `ej.inputs.Uploader`
...
| Item | Count |
|---|---:|
| Static JS members | 52 |
| Static event members | 20 |
| Event payload entries | 20 |
