# FusionDropDownTree Master Use Cases
...
`FusionDropDownTree`. Existing C#, sandbox, tests, docs, and memory are evidence
only after raw EJ2 discovery and primitive mapping prove them.

Syncfusion target: `ej.dropdowns.DropDownTree`
...
| Item | Count |
|---|---:|
| Static JS members | 60 |
| Static event members | 13 |
| Event payload entries | 13 |
