...
import { useStory, useReviews, useDispatchReview, useComments, useCreateComment, useDecisions, useCreateDecision, useUpdateStory } from '@/hooks/queries';
        ...
        <form onSubmit={handleSaveEdit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows={12}
              className="w-full px-3 py-2 text-sm rounded-md border border-input bg-background font-mono focus:outline-none focus:ring-2 focus:ring-ring resize-y"
            />
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <textarea value={editIndependent} onChange={(e) => setEditIndependent(e.target.value)} rows={2} className="w-full px-3 py-1.5 text-sm rounded-md border border-input bg-background focus:outline-none focus:ring-2 focus:ring-ring resize-none" />
              </div>
              <div>
                <label className="block text-xs font-medium text-muted-foreground mb-1">Negotiable</label>
                <textarea value={editNegotiable} onChange={(e) => setEditNegotiable(e.target.value)} rows={2} className="w-full px-3 py-1.5 text-sm rounded-md border border-input bg-background focus:outline-none focus:ring-2 focus:ring-ring resize-none" />
              </div>
              <div>
                <label className="block text-xs font-medium text-muted-foreground mb-1">Valuable</label>
                <textarea value={editValuable} onChange={(e) => setEditValuable(e.target.value)} rows={2} className="w-full px-3 py-1.5 text-sm rounded-md border border-input bg-background focus:outline-none focus:ring-2 focus:ring-ring resize-none" />
              </div>
              <div>
                <label className="block text-xs font-medium text-muted-foreground mb-1">Estimable</label>
                <textarea value={editEstimable} onChange={(e) => setEditEstimable(e.target.value)} rows={2} className="w-full px-3 py-1.5 text-sm rounded-md border border-input bg-background focus:outline-none focus:ring-2 focus:ring-ring resize-none" />
              </div>
              <div>
                <label className="block text-xs font-medium text-muted-foreground mb-1">Small</label>
                <textarea value={editSmall} onChange={(e) => setEditSmall(e.target.value)} rows={2} className="w-full px-3 py-1.5 text-sm rounded-md border border-input bg-background focus:outline-none focus:ring-2 focus:ring-ring resize-none" />
              </div>
              <div>
                <label className="block text-xs font-medium text-muted-foreground mb-1">Testable</label>
                <textarea value={editTestable} onChange={(e) => setEditTestable(e.target.value)} rows={2} className="w-full px-3 py-1.5 text-sm rounded-md border border-input bg-background focus:outline-none focus:ring-2 focus:ring-ring resize-none" />
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 justify-end">
            <button
              ...
              className="px-4 py-2 text-xs rounded-md border border-border text-muted-foreground hover:bg-muted transition-colors"
            >
              Cancel
            </button>
            <button
              ...
              className="px-4 py-2 text-xs rounded-md bg-primary text-primary-foreground hover:bg-primary/90 disabled:opacity-50 transition-colors"
            >
        ...
        <>
          <div className="flex items-start justify-between gap-4">
            ...
            <button
              ...
              className="px-3 py-1 text-xs rounded-md border border-border text-muted-foreground hover:bg-muted transition-colors shrink-0"
            >
              Edit
            </button>
          </div>
