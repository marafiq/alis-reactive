  ...
  it("adds a class to an element", () => {
    boot({
      ...
      entries: [{
        ...
        reaction: {
          kind: "sequential",
          commands: [{ kind: "mutate-element", target: "status", mutation: { kind: "call", method: "add", chain: "classList", args: [{ kind: "literal", value: "active" }] } }],
        },
      }],
    });
  ...
  it("removes a class from an element", () => {
    boot({
      ...
      entries: [{
        ...
        reaction: {
          kind: "sequential",
          commands: [{ kind: "mutate-element", target: "status", mutation: { kind: "call", method: "remove", chain: "classList", args: [{ kind: "literal", value: "text-muted" }] } }],
        },
      }],
    });
  ...
  it("shows a hidden element", () => {
    boot({
      ...
      entries: [{
        ...
        reaction: {
          kind: "sequential",
          commands: [{ kind: "mutate-element", target: "loader", mutation: { kind: "call", method: "removeAttribute", args: [{ kind: "literal", value: "hidden" }] } }],
        },
      }],
    });
  ...
  it("hides a visible element", () => {
    boot({
      ...
      entries: [{
        ...
        reaction: {
          kind: "sequential",
          commands: [{ kind: "mutate-element", target: "content", mutation: { kind: "call", method: "setAttribute", args: [{ kind: "literal", value: "hidden" }, { kind: "literal", value: "" }] } }],
        },
      }],
    });
  ...
  it("toggles a class", () => {
    boot({
      ...
      entries: [{
        ...
        reaction: {
          kind: "sequential",
          commands: [{ kind: "mutate-element", target: "status", mutation: { kind: "call", method: "toggle", chain: "classList", args: [{ kind: "literal", value: "text-muted" }] } }],
        },
      }],
    });
