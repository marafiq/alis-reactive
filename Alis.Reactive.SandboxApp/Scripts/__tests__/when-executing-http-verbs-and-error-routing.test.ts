...
import type { RequestDescriptor, ConditionalReaction } from "../types";
...
describe("PUT verb", () => {
  it("sends PUT method in fetch request", async () => {
    ...
    const req: RequestDescriptor = {
      ...
      onSuccess: [{
        commands: [{ kind: "mutate-element", target: "result", mutation: { kind: "set-prop", prop: "textContent", value: { kind: "literal", value: "updated" } } }],
      }],
    };
...
describe("DELETE verb", () => {
  it("sends DELETE method in fetch request", async () => {
    ...
    const req: RequestDescriptor = {
      ...
      url: "/api/delete/42",
      onSuccess: [{
        commands: [{ kind: "mutate-element", target: "result", mutation: { kind: "set-prop", prop: "textContent", value: { kind: "literal", value: "deleted" } } }],
      }],
    };
...
describe("multi-status error routing", () => {
  it("routes 422 to matching handler, not 400 or catch-all", async () => {
    ...
    const req: RequestDescriptor = {
      ...
      url: "/api/validate",
      onError: [
        { statusCode: 400, commands: [{ kind: "mutate-element", target: "error", mutation: { kind: "set-prop", prop: "textContent", value: { kind: "literal", value: "400 error" } } }] },
        { statusCode: 422, commands: [{ kind: "mutate-element", target: "error", mutation: { kind: "set-prop", prop: "textContent", value: { kind: "literal", value: "422 validation" } } }] },
        { statusCode: 500, commands: [{ kind: "mutate-element", target: "error", mutation: { kind: "set-prop", prop: "textContent", value: { kind: "literal", value: "500 server" } } }] },
  ...
  it("routes 500 to matching handler", async () => {
    ...
    const req: RequestDescriptor = {
      ...
      url: "/api/validate",
      onError: [
        { statusCode: 422, commands: [{ kind: "mutate-element", target: "error", mutation: { kind: "set-prop", prop: "textContent", value: { kind: "literal", value: "422" } } }] },
        { statusCode: 500, commands: [{ kind: "mutate-element", target: "error", mutation: { kind: "set-prop", prop: "textContent", value: { kind: "literal", value: "500 server" } } }] },
      ],
    };
  ...
  it("falls to catch-all when no status matches", async () => {
    ...
    const req: RequestDescriptor = {
      ...
      onError: [
        { statusCode: 422, commands: [{ kind: "mutate-element", target: "error", mutation: { kind: "set-prop", prop: "textContent", value: { kind: "literal", value: "422" } } }] },
        { statusCode: 500, commands: [{ kind: "mutate-element", target: "error", mutation: { kind: "set-prop", prop: "textContent", value: { kind: "literal", value: "500" } } }] },
        { commands: [{ kind: "mutate-element", target: "error", mutation: { kind: "set-prop", prop: "textContent", value: { kind: "literal", value: "unknown error" } } }] },
      ],
    };
...
describe("GET with gather items as URL params", () => {
  it("appends static gather items as query params for GET", async () => {
    ...
    const req: RequestDescriptor = {
      ...
      onSuccess: [{
        commands: [{ kind: "mutate-element", target: "result", mutation: { kind: "set-prop", prop: "textContent", value: { kind: "literal", value: "found" } } }],
      }],
    };
...
describe("component gather sends nested JSON body", () => {
  it("gathers component values and sends as POST body", async () => {
    ...
    const req: RequestDescriptor = {
      ...
      onSuccess: [{
        commands: [{ kind: "mutate-element", target: "result", mutation: { kind: "set-prop", prop: "textContent", value: { kind: "literal", value: "submitted" } } }],
      }],
    };
