...
{
    [Area("Sandbox")]
    [Route("Sandbox/AllModulesTogether/PlaygroundSyntax")]
    public class PlaygroundSyntaxController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            return View("~/Areas/Sandbox/Views/AllModulesTogether/PlaygroundSyntax/Index.cshtml", new PlaygroundSyntaxModel
            {
        ...
        public IActionResult ReactiveConditions()
        {
            ...
            return View("~/Areas/Sandbox/Views/AllModulesTogether/PlaygroundSyntax/ReactiveConditions.cshtml", new PlaygroundSyntaxModel
            {
                Address = new PlaygroundAddress()
            });
        }
