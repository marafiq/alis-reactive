...
namespace Alis.Reactive.SandboxApp.Areas.Sandbox.Controllers.Patterns.FormPatterns
{
    [Area("Sandbox")]
    [Route("Sandbox/Patterns/IdGenerator")]
    public class IdGeneratorController : Controller
    {
        [HttpGet("")]
        public IActionResult Index()
        {
            return View("~/Areas/Sandbox/Views/Patterns/IdGenerator/Index.cshtml", new IdGeneratorModel
            {
                Name = "Test",
                Amount = 42.5m,
                Status = "active",
