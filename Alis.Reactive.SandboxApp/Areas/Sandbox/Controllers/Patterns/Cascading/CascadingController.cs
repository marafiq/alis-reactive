...
namespace Alis.Reactive.SandboxApp.Areas.Sandbox.Controllers.Patterns.Cascading
{
    [Area("Sandbox")]
    [Route("Sandbox/Patterns/Cascading")]
    public class CascadingController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            return View("~/Areas/Sandbox/Views/Patterns/Cascading/Index.cshtml", new CascadingModel());
        }
