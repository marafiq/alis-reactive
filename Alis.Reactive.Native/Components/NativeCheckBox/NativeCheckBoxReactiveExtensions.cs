...
namespace Alis.Reactive.Native.Components
{
    ...
    public static class NativeCheckBoxReactiveExtensions
    {
        ...
        /// <typeparam name="TProp">The model value type associated with the checkbox component.</typeparam>
        /// <typeparam name="TArgs">The event args type selected by <paramref name="eventSelector"/>.</typeparam>
        /// <param name="builder">The NativeCheckBox builder being wired.</param>
