...
{
    /// <summary>
    /// Wires <see cref="FusionComboBox"/> events into the Reactive Plan.
    /// </summary>
    public static class FusionComboBoxReactiveExtensions
    {
        ...
        /// <param name="builder">The FusionComboBox builder being wired.</param>
        ...
        public static ComboBoxBuilder Reactive<TModel, TArgs>(
            ...
            where TModel : class
        {
            var typedEvent = eventSelector(FusionComboBoxEvents.Instance);
