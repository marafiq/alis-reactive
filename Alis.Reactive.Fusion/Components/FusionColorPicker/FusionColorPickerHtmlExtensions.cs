...
using ComponentRegistrationSource = Alis.Reactive.Fusion.Components.FusionColorPicker;
...
namespace Alis.Reactive.Fusion.Components
{
    ...
    public static class FusionColorPickerHtmlExtensions
    {
        ...
        /// <typeparam name="TProp">The model value type rendered by the color picker.</typeparam>
