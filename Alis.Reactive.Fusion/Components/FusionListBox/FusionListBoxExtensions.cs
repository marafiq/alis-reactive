...
{
    /// <summary>
    /// Reads and updates <see cref="FusionListBox"/> selected values from a Reactive Plan pipeline.
    /// </summary>
    public static class FusionListBoxExtensions
    {
        ...
        /// <summary>Applies pending ListBox property changes to the rendered component.</summary>
        ...
        /// <summary>Reads selected string values.</summary>
