...
{
    /// <summary>
    /// Wraps rendered Syncfusion schedule markup while carrying plan metadata for <c>.Reactive(...)</c> chaining.
    /// </summary>
        ...
        where TModel : class
    {
        ...
        internal FusionScheduleBuilder(ReactivePlan<TModel> plan, string elementId,
#if NET48
            IHtmlString inner)
#else
            IHtmlContent inner)
