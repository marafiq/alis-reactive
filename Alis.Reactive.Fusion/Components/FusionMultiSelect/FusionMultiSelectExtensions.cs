...
{
    /// <summary>
    /// Reactive Plan pipeline extensions for reading from and updating <see cref="FusionMultiSelect"/>.
    /// </summary>
    /// <remarks>
    ...
    public static class FusionMultiSelectExtensions
    {
        ...
        /// <summary>Applies pending MultiSelect property changes to the rendered component.</summary>
        ...
        /// <summary>Reads the selected value array for conditions or gather.</summary>
        /// <remarks>
