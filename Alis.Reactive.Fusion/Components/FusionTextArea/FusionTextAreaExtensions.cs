...
{
    /// <summary>
    /// Reads and updates <see cref="FusionTextArea"/> values from a Reactive Plan pipeline.
    /// </summary>
    public static class FusionTextAreaExtensions
    {
        ...
        /// <summary>Sets visible textarea value.</summary>
        ...
        /// <summary>Reads text value for conditions or gather.</summary>
