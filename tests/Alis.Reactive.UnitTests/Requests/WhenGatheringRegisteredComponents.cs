...
public class WhenGatheringRegisteredComponents : PlanTestBase
{
    ...
    {
        var plan = CreatePlan();
        plan.AddToComponentsMap("Name", new ComponentRegistration("comp1", "native", "Name", "value", "textbox", Alis.Reactive.PlanModel.Shape.String));
        plan.AddToComponentsMap("Amount", new ComponentRegistration("comp2", "fusion", "Amount", "value", "numerictextbox", Alis.Reactive.PlanModel.Shape.Number));
    ...
    {
        var plan = CreatePlan();
        plan.AddToComponentsMap("Status", new ComponentRegistration("comp1", "native", "Status", "value", "textbox", Alis.Reactive.PlanModel.Shape.String));
