...
namespace Alis.Reactive.Native.Components
{
    ...
    public static class NativeActionLinkHtmlExtensions
    {
        public static NativeActionLinkBuilder<TModel> NativeActionLink<TModel>(
            ...
            string linkText,
            string url,
            Func<Alis.Reactive.Builders.PipelineBuilder<TModel>, Alis.Reactive.Builders.Requests.HttpRequestBuilder<TModel>> configure)
            where TModel : class
...
public class GeneratedView
{
    ...
    public void Execute()
    {
        Html.NativeActionLink(""Delete"", ""/orders/delete/42"", p => p
            .Post(""/orders/delete/42"")
...
public class GeneratedView
{
    ...
    public void Execute()
    {
        Html.NativeActionLink(""Delete"", ""/orders/delete/42"", {|#0:p =>
        {
            ...
            return p.Post(""/orders/delete/42"");
        }|});
    }
}";
...
public class GeneratedView
{
    ...
    public void Execute()
    {
        Html.NativeActionLink(""Delete"", ""/orders/delete/42"", {|#0:p => p
            .Post(""/orders/delete/42"")
