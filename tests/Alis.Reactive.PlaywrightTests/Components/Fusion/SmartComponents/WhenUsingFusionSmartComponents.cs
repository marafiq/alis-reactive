namespace Alis.Reactive.PlaywrightTests.Components.Fusion.SmartComponents;
...
public class WhenUsingFusionSmartComponents : PlaywrightTestBase
{
    ...
    public async Task component_index_links_to_smart_components_sandbox()
    {
        ...
        var smartComponentsSandboxLinks =
            Page.Locator("a[href='/Sandbox/Components/SmartComponents/Index']");

        await Expect(smartComponentsSandboxLinks.First)
            .ToBeVisibleAsync(new() { Timeout = 10000 });
