...
///
/// Page under test: /Sandbox/MultiColumnComboBox
///
...
/// </summary>
[TestFixture]
public class WhenUsingFusionMultiColumnComboBox : PlaywrightTestBase
{
    private const string Path = "/Sandbox/MultiColumnComboBox";
    ...
    public async Task gather_sends_initial_facility_value_to_server()
    {
        ...
        var request = await Page.RunAndWaitForRequestAsync(
            ...
            "**/Sandbox/MultiColumnComboBox/Echo");
