...
///
/// Page under test: /Sandbox/NativeHiddenField
/// </summary>
[TestFixture]
public class WhenUsingNativeHiddenField : PlaywrightTestBase
{
    private const string Path = "/Sandbox/NativeHiddenField";
