...
- No internal type names in user docs: "descriptors", "entries", "CallReaction", "SetReaction", "SequenceReaction". Use "intent", "fluent builders", "reactions". Reserve internals for contributor docs.
